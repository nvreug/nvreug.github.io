...
\begin{list1}
	\item[] Co-chair
	\begin{list2}
		\item[] Maria Garcia-Osipenko (in progress)
		\item[] Emre Koseman (in progress)
	\end{list2}
    \item[] Committee member
	\begin{list2}
		\item[] Ozgen Kiribrahim-Sarikaya, 2025 (Sabanci University)
		\item[] Nicolas Bozzo, 2025 (Keystone Strategy)
        \item[] Ujjwol Paudel, 2025 (ASU Postdoc)
        \item[] Konstantin Von Beringe, (in progress)
