...
\section{ Employment and Affiliations}
\begin{list1}
	...
	\item[] \hspace{11pt} Faculty Research Fellow, Environment and Energy Economics (EEE), May 2026 -
	\item[] Uber:
...
\item[] \href{https://nvreug.github.io/paper/dynamic_regulation_published.pdf}{``Dynamic Regulation with Firm Linkages: Evidence from Texas''} (with Matthew Leisten) Accepted at the \textbf{Review of Economic Studies}.
\item[] \href{https://nvreug.github.io/paper/oil_incomplete.pdf}{``Supply Side Climate Policies and Capital Reallocation:
Evidence from the Offshore Oil and Gas Industry''} Accepted at the \textbf{RAND Journal of Economics}.
\end{list1}

\section{Working Papers and Work in Progress}
\begin{list1}

\item[] \href{https://nvreug.github.io/paper/containerships.pdf}{``Endogenous Rigidities and Capital Misallocation: Evidence from Containerships''} (with Maria Garcia-Osipenko and Nahim Zahur) Revised and Resubmitted at the \textbf{Journal of Political Economy}.

\item[] \href{https://nvreug.github.io/paper/gkpv.pdf}{``Optimal Second-best Menu Design: Evidence from Residential Electricity Plans''} (with Maria Garcia-Osipenko, Nicolai Kuminoff, and Spencer Perry) Revised and Resubmitted at the \textbf{Journal of the European Economic Association}.

\item[] \href{https://nvreug.github.io/paper/permits_sept_14.pdf}{``Permits as Real Options: Anticipation and Regulatory Leakage''} (with Anna French)

\end{list1}

\section{Fellowships and Awards}
\begin{list1}
\item[] Harrington Faculty Fellow, University of Texas at Austin, 2026-2027
...
\begin{list1}
\item[] 2026: KEERE, Kellogg, SEA, Texas A\&M IO Day, Toulouse, UC Berkeley ARE, University of Connecticut, University of Michigan, University of Minnesota
\item[] 2025: U Chicago IO+ Conference, Calgary, IIOC, NBER EEE Spring Meeting, Northwestern, U Chicago (Harris)
...
\section{PhD Students and Placements}
\begin{list1}
	\item[] Co-chair
	\begin{list2}
		\item[] Maria Garcia-Osipenko, 2026 (Research Economist, Dallas Fed)
		\item[] Emre Koseman (in progress)
	\end{list2}
    \item[] Committee member
	\begin{list2}
		\item[] Ozgen Kiribrahim-Sarikaya, 2025 (Assistant Professor, Sabanci University)
		\item[] Nicolas Bozzo, 2025 (Economist, Keystone AI)
        \item[] Ujjwol Paudel, 2025 (Assistant Professor, Texas Tech University)
        \item[] Konstantin Von Beringe, 2026 (Assistant Professor, University of South Carolina)
        \item[] Anna French, (in progress)
	\end{list2}
\end{list1}

\section{Journal Referee}
\begin{list1}
	\item[] Review of Economic Studies, Review of Economic Dynamics, Inter-American Development Bank Working Paper Series, International Journal of Industrial Organization, JAERE, Journal of Political Economy, JPE Micro, Journal of Public Economics, AEJ Micro, Econometrica, American Economic Review
\end{list1}

\section{Grants}
\begin{list1}
    \item[] 2026: W. P. Carey Excellence in Research Summer Grant.
    \item[] 2025: W. P. Carey Excellence in Research Summer Grant.
...
\section{Citizenship}
\begin{list1}
	\item[] Australian, US Permanent Resident
	\vspace*{.05in}
\end{list1}
